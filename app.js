...
const translations = {
  ru: {
    ...
    hero_desc: "Инженер по ручному тестированию с фокусом на веб-сервисах, мобильных приложениях и REST API. Отлавливаю дефекты до релиза и пользователей, пишу понятную тестовую документацию (Test Plan, Test Cases, Checklists, Bug Reports) и помогаю команде спокойно выпускать продукт в продакшен.",
